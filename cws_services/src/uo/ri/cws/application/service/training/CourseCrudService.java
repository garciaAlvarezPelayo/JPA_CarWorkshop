...
public interface CourseCrudService {
	 ...
	 * 
	 * @param dto,
	 *            it must specify: name, description, startDate, endDate, hours
	 ...
	 *             if: - any field other than id and version is null or empty,
	 *             or - there already exists a course with the same name, or -
	 *             there is percentage devoted to a non existing vehicle type,
	 *             or - the initial and final dates are in the past or inverted,
	 *             or - the number of hours are zero or negative, or - there are
	 *             no dedications specified, or - the sum of devoted percentages
	 *             does not equals 100%, or - the are any dedication with an
	 *             invalid percentage (empty, zero, negative)
	 */
	 ...
	 * 
	 * @param dto.
	 *            Must specify all the fields. The id and version fields must
	 ...
	 * 
	 * @throws BusinessException
	 *             if: - it does not exist the course with the specified id, or
	 *             - the current version of the course does not match the
	 *             version of the dto, or - the course has its start date in the
	 *             past, or - the new data does not pass the validation
	 ...
	 * @param id
	 * @throws BusinessException
	 *             if: - there is no course with the specified id, or - the
	 *             course already has enrollments registered.
	 */
