...
public interface CourseAttendanceService {
	 ...
	 * 
	 * @param dto,
	 *            with this fields filled: mechanicId, courseId, attendance and
	 *            the boolean passed.
	 *
	 ...
	 *             if: - the mechanic id does not exit, or - the course id does
	 *             not exist, or - there already is another enrollment
	 *             registered for the same mechanic and course, or - the
	 *             attendance is under 85% and the course is marked as passed,
	 *             or - the course is not yet finished, or <- IGNORE THIS,
	 *             complicates testing - the value for percentage is not in the
	 *             range 0..100
	 */
