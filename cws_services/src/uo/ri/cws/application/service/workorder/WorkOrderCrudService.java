...
public interface WorkOrderCrudService {
	 ...
	 *
	 * @param dto.
	 *            Just vehicle id and description.
	 *
	 * @return another dto with the provided values and service-assigned fields
	 *         filled: id, date and status
	 *
	 * @throws BusinessException
	 *             if: - there is another work order for the same vehicle at the
	 *             same date and time (timestamp), or - the vehicle does not
	 *             exist
	 */
	 ...
	 *
	 * @param dto,
	 *            with work order id, version and description.
	 *
	 * @throws BusinessException
	 *             if: - there is no work order with that id, or - there work
	 *             order has not the specified version (optimistic lock), or -
	 ...
	 *
	 * @throws BusinessException
	 *             if: - the work order does not exist, or - there already is
	 *             some intervention registered.
	 */
